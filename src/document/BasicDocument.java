...
public class BasicDocument extends Document 
{
	...
	{
        return getTokens("[.!?]+|[a-z|A-Z|0-9]$").size();
	}
	...
	public int getNumSyllables()
	{
		...
		for(String word : words) {
			numSyllales += countSyllables(word.toLowerCase());
		}
	...
	public static void main(String[] args)
	{
		...
		BasicDocument b = new BasicDocument("This is a test.  How many??? Senteeeeeeeeeences are here... there should be 5!  Right?");
		System.out.format("Number of sentence:[%d], number of words:[%d], number of syllables:[%d]", b.getNumSentences(), b.getNumWords(), b.getNumSyllables());		
		System.out.format("getFleschScore :[%f]", b.getFleschScore());
